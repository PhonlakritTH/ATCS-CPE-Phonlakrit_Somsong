...
def run():
    ...
    print(f"Real document from privacy.txt is {total_chars} characters long ({len(data)} Q&A)")
    ...
    print("Golden Set =", len(data), "(uses every question in privacy.txt as the test set)")
